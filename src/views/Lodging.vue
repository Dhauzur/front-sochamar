      ...
      <b-row  class="mx-1">
        <b-col md="6" lg="5" xl="3">
          <b-row>
            ...
            <b-col xs="12" md="6" lg="6" class="mb-2" v-if="lodgings.length == 0 && company">
              <b-button
            ...
            <b-col xs="12" md="6" xl="4" class="mb-2" v-if="getMirrorLodging || editMode">
              <button type="button"
